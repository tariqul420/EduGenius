      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {subjects?.map((subject, index) => (
          <Link
            ...
            key={index}
            className="flex flex-col items-center p-6 bg-light-bg dark:bg-dark-bg rounded-lg shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 transform cursor-pointer dark:bg-black-light"
            role="button"
