...
function HeroSection() {
  return (
    <section className="relative min-h-[650px] overflow-hidden dark:bg-black">
      ...
      <div className="relative h-full  container mx-auto flex flex-col items-center justify-between overflow-hidden px-2 py-12 md:gap-5 md:px-5 lg:max-w-6xl lg:flex-row">
        <Image
