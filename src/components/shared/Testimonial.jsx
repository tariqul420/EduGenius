...
//       {/* Carousel Container */}
//       <div className="relative p-8 border mt-8 flex flex-col md:flex-row items-center text-center md:text-left">
//         {/* Left Arrow */}
//         <button
//           className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-green-500 mr-4 text-2xl"
//           onClick={handlePrev}
//         >
...
//             <h1 className="text-lg font-semibold">"{testimonials[index].review}"</h1>
